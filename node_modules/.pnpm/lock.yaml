...
packages:
  ...
  /express-flash@0.0.2:
    resolution: {integrity: sha512-QVUR0ZZRCaa8+iPHoUQaQJrQWcQuK/Q+19M7IUIdIEtvwhrA/ifHT7y1CVJI41YfGiOQnbGtn3uvd2vOdgu58A==}
    engines: {node: '>= 0.8.0'}
    dependencies:
      connect-flash: 0.1.1
    dev: false
  ...
  /oracledb@6.4.0:
    resolution: {integrity: sha512-TJI08qzQlf/l7T49VojP9BoQpjEr14NXZmpSzzcLrbNs7qSl0QA/Mc9gGiEdkg5WmwH0wqUjtMC7jlf1WamlYA==}
    engines: {node: '>=14.6'}
    requiresBuild: true
    dev: false
